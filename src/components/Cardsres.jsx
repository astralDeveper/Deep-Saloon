...
const Cardsres = () => {
  ...
  return (
    <main className="w-full flex items-center justify-evenly flex-wrap ">
      {cardData.map((data, index) => (
        <div className="border border-yellow-500 p-4 rounded-xl w-[38%] max-lg:w-full max-md:mb-6 bg-[#343434]">
